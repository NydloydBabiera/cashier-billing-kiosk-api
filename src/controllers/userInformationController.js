...
const addNewUser = async (req, res) => {
  ...
  try {
    const addUserInformation = await UserInformation.create(userInformation , { transaction:createUser });
    ...
    const addUserIdentification = await UserIdentification.create(
      userIdentification,  { transaction:createUser }
    );
    ...
    const addUserAuthentication = await AuthenticateUser.create(
      authCredentials,  {  transaction:createUser }
    );
